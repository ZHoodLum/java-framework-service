 ...
 * @Description:坏男人 饿汉式实例化，类加载时初始化，实例化对象
 *
 * 是否 Lazy 初始化：否
 * 是否多线程安全：是
 * 实现难度：易
...
public class BadManSingLeton {
    private static BadManSingLeton instance = new BadManSingLeton();

    private BadManSingLeton() {
    }

    public static BadManSingLeton getInstance() {
        return instance;
    }
}
